    ...
    <>
      ...
      <header id="home" className="hero-section">
        ...
        <div className="footer-graphic-box">
          <div className="exact-scene-canvas structural-freeze">
            <img src="/generated_images.png" alt="Thibaut Desk Environment Setup" className="scene-background-plate" />
        ...
        <main className="projects-section">
          ...
          <div className="project-item">
            ...
            <div className="project-visual-wrapper slider-container">
              <div className="image-slider" ref={sliderRef}>
                <img src="/screenshot(454).png" alt="Dashboard Panel Interface View" />
                <img src="/screenshot(455).png" alt="Dashboard Panel Interface View" />
                <img src="/screenshot(456).png" alt="Dashboard Panel Interface View" />
                <img src="/screenshot(457).png" alt="Dashboard Panel Interface View" />
                <img src="/screenshot(458).png" alt="Dashboard Panel Interface View" />
                <img src="/screenshot(459).png" alt="Dashboard Panel Interface View" />
                <img src="/screenshot(460).png" alt="Dashboard Panel Interface View" />
              </div>
            </div>
          </div>
          ...
          <div className="project-item">
            ...
            <div className="project-visual-wrapper video-container">
              <video src="/proffy.mp4" muted autoPlay loop playsInline className="showcase-video" />
            </div>
          </div>
          ...
          <div className="project-item">
            ...
            <div className="project-visual-wrapper">
              <img src="/screenshot(500).png" alt="" className="showcase-video" />
      ...
      <section id="about" className="about-section">
        ...
        <div className="hero-laptop-chassis">
          <img src="/mechanicalkeyboard.png" alt="Modern Laptop Casing Showcase" className="laptop-hardware-image" />
        </div>
      </section>
